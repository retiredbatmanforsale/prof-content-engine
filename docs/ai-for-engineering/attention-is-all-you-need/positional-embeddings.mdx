...
<LessonHero course="Attention Is All You Need" number="3" title="Positional embeddings & encodings" subtitle="Telling the model where each token sits in the sequence" />
